...
public class ClientFormController implements Initializable {
    ...
    private void loadDate() {
        lablDate.setText(String.valueOf(LocalDate.now()));
    ...
    void sendBtnOnAction(ActionEvent event) {
        ...
        messageLabel.setStyle("-fx-background-color:green;-fx-background-radius:15;-fx-font-size: 16;-fx-alignment: center;-fx-padding: 5px;");
        if (!message.isEmpty()) {
            try {
    ...
    void btnImageOnAction(ActionEvent event) {
        ...
        if (file != null) {
            try {
                ...
                ImageView imageView = new ImageView(new Image(uri.toString()));
                imageView.setFitWidth(100);
                imageView.setPreserveRatio(true);

                HBox imageHbox = new HBox(imageView);
                imageHbox.setStyle("-fx-background-color: FFF5E4;-fx-background-radius:15;-fx-alignment: center;-fx-padding: 20px 5px;");
